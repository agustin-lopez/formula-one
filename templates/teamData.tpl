...
<div class="main-data-container container">
    ...
    <div class="info-container">
        ...
        <div class="info">
            ...
            <p><strong>Driver one: </strong> <a href="drivers/{$driversData[0]->id}">{$driversData[0]->driverName}</a></p>
            <p><strong>Driver two: </strong> <a href="drivers/{$driversData[1]->id}">{$driversData[1]->driverName}</a></p>
